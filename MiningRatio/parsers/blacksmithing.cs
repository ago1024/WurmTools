...
public class BlacksmithingMessageParser : IMessageParser
{
    ...
    private readonly Regex reEnd2 = new Regex("You (need|will want) to polish .* with a pelt before you improve it");
    ...
    private readonly Regex reSkill = new Regex("Blacksmithing increased");
